"""
Document parser module - combines BaseParser + MarkdownParser into single module.

Migrated from: rag/parser/base.py, rag/parser/markdown_parser.py, rag/parser/__init__.py
"""
...
from src.common.models import ParsedDocument, TableData
...
# Convenience functions (from original rag/parser/__init__.py)
