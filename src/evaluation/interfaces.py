...
if TYPE_CHECKING:
    from src.evaluation.evaluator import RAGEvaluationResult
    from src.evaluation.generation_eval import GenerationMetrics
    from src.evaluation.medical_safety_eval import MedicalSafetyMetrics
    from src.evaluation.retrieval_eval import RetrievalMetrics
